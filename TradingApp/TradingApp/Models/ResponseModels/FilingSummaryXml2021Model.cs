namespace TradingApp.Models.ResponseModels
{
	...
	public class FilingSummaryXml2021Model
    {
		...
		[XmlRoot(ElementName = "SupplementalFiles")]
		public class SupplementalFiles
		{
			[XmlElement(ElementName = "File")]
		...
		public class FilingSummary2021
		{
			...
			public SupplementalFiles SupplementalFiles { get; set; }
